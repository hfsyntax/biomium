...
`);
        ...
        setTimeout(() => {
            if (localStorage.getItem("skin-select")) {
        ...
        skinSelect.onchange = function () {
            ...
            localStorage.setItem("skin-select", skinSelect.value)
        }
